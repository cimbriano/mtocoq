...
# coq_makefile -o makefile Sflib.v core.v lemmas.v low_equivalence_properties.v mto_arith.v mto_paper_definitions.v semantics.v strong_induction.v tactic_notations.v theorem.v typing.v unproven_lemmas.v unused_definitions.v 
#
...
VFILES:=Sflib.v\
  core.v\
  lemmas.v\
  low_equivalence_properties.v\
  mto_arith.v\
  mto_paper_definitions.v\
  semantics.v\
  strong_induction.v\
  tactic_notations.v\
  theorem.v\
